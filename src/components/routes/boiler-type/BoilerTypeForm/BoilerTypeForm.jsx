...
const BoilerTypeForm = (props) => {
  ...
  const [newOne] = useState({
    ...
    technicians: props.editing ? boilerType[0].technician : [],
  });
  ...
  const [technicianId, setTechnicianId] = useState(
    props.editing ? boilerType[0].technicians : []
  );
  ...
  return (
    <Form
      ...
      onChange={{
        technicians: handleSelectTechniciansChange,
      }}
              ...
              <div style={columnStyle}>
                ...
                <div style={fieldStyle}>
                  <Field
                    ...
                    placeholder="Detail accumulated eventual maintenance hours"
